    ...
    if args.mode == 'build':
        ...
        with tf.Session(config=tf_config) as sess:
            ...
            for k, v in val_data.items():
                ...
                # print('imgs.shape:', imgs.shape, '    imgs_f.shape:', imgs_f.shape, '    len(issame):', len(issame))  # Bernardo
                ...
                # print('embds_arr.shape:', embds_arr.shape)      # Bernardo
                ...
                # print('embds_f_arr.shape:', embds_f_arr.shape)  # Bernardo
